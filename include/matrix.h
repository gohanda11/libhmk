...
typedef struct {
  ...
  // Key travel distance (0-TRAVEL_UNITS)
  uint16_t distance;
  // Last extremum point of the key travel distance (0-TRAVEL_UNITS)
  uint16_t extremum;
 ...
 *
 * @param key Key index
 * @param distance Travel distance in the range [0, TRAVEL_UNITS]
 *
 * @return None
 */
